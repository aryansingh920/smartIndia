...
// let animateMesh;
// animateBlender.load('./gltf/pot.gltf', (gltf)=>{
//   animateMesh = gltf.scene;
  
//   scene.add(animateMesh);
// })

let animateBlender1 = new GLTFLoader();

let animateMesh1;
animateBlender1.load('./gltf/ClayPots.gltf', (gltf)=>{
  animateMesh1 = gltf.scene;
  
  scene.add(animateMesh1);
})
...
//space texture
const spaceTexture = new THREE.TextureLoader().load('backgound.png');
//set background
